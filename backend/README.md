...
## Project Structure
    ...
    ├── testapiautostoryboa_62204  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_62204`
...
2. Clone this repo and `cd testapiautostoryboa_62204`
